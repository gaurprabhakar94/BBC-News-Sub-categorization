...
getwd()
setwd("C:/Users/PG/Desktop/Data Analysis in R/4 Network Graphs/10combined")
getwd()
...
#write as csv file
write.csv(m,file="C:/Users/PG/Desktop/Data Analysis in R/4 Network Graphs/DTM.csv")
...
write.csv(filekey,"C:/Users/PG/Desktop/Data Analysis in R/4 Network Graphs/FileKey.csv")
...
cs <- cosineSim(m)
write.csv(as.matrix(cs),file="C:/Users/PG/Desktop/Data Analysis in R/4 Network Graphs/CosineSimilarity.csv")
...
cs[cs < max(cs)/2] <- 0
cs <- round(cs,3)
write.csv(as.matrix(cs),file="C:/Users/PG/Desktop/Data Analysis in R/4 Network Graphs/AdjacencyMatrix.csv")
