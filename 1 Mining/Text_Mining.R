getwd()
setwd("C:/Users/PG/Desktop/BBC news sub category/1 Mining/")
getwd()
library(tm)

#Create Corpus with all documents in the directory
docs <- Corpus (DirSource ("C:/Users/PG/Desktop/BBC news sub category/1 Mining/10combined/."))
docs
...
findAssocs(dtmr,"world",0.6)
findAssocs(dtmr,"birmingham",0.6)
